...
- Configuration changes (pricing, content, settings)
...
- Update relevant sections (color schemes, design systems, etc.) if they changed

## Key Customization File

The primary customization point is `src/lib/constants.ts` - contains ALL landing page content (features, pricing, testimonials, etc.).
